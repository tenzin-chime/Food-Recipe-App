...
document.getElementById('btn').addEventListener('click',()=>{
    ...
    mealAPI.then((getData)=>{
        ...
        sendData.meals.forEach(e => {
            ...
            <h2 class="text-center text-danger">Food Name: ${e.strMeal}</h2>
            <div class="row">
            <div class="col-md-4">
        ...
        <div class="col-6 offset-3">
            <h2 class="text-center">Watch Full video on <a class="text-danger yt" data-bs-toggle="modal" data-bs-target="#exampleModal"><u>Youtube</u></a></h2>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        ` 
        heading.innerHTML=`<h2 class="text-center text-warning">Food Category: ${e.strCategory}</h2>`;
